...
(function() {
  var Course, Scheduler, Section, Session;
  ...
  Course = (function() {
    function Course(name, number, sessions) {
      this.name = name;
      this.number = number;
  ...
  Scheduler = (function() {
    ...
    Scheduler.prototype.combine = function() {
      ...
      chosen = [];
      schedules = [];
      return recursiveCombine(this.courses, chosen, schedules);
    };
    ...
    Scheduler.prototype.overlap = function(scheduleA, scheduleB) {
      return false;
    };
